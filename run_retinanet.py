...
def main():
    """
    Main function to run real-time object detection with RetinaNet on webcam feed
    and save the processed video to a file
    """
    # Step 1: Load the pre-trained RetinaNet model
    ...
    output_filename = os.path.join(output_dir, f"retinanet_detection_{timestamp}.mp4")
    ...
    try:
        while True:
            ...
            cv2.imshow('RetinaNet Object Detection (Recording)', frame_with_detections)
